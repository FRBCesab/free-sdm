...
#'
#' @notes For future horizons, if no values RCP are specified, projections for all available RCP will downloaded for the chosen GCMs. If no values GCM are specified, projections for all available GCM will downloaded for the chosen RCPs.
#'
#' @examples
#'
#' wget_chelsa(
